    ...
    <div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <div class="breadcrumb mb-5" style="margin-top: -12px">
                ...
                <li>
                    <a class="breadcrumb-item active" href="">{{trans('billing.create_bl_alert')}}</a>
            ...
            <div class="main-card mb-3 card">
                ...
                <ul class="nav nav-tabs justify-content-center" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#before" role="tab">
                            {{trans('billing.before_exp_date')}}
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#after" role="tab">
                ...
                <div class="card-body">
                    <div class="tab-content text-center">
                        <div class="tab-pane active" id="before" role="tabpanel">
                            <form class="form-horizontal" method="POST" action="{{ route('billing-alerts.before') }}" >
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label for="number_days_before">
                                            ...
                                            @endforeach
                                        </label>&nbspday(s) before expire data.
                                    </div>
                                </div>
                                <div class="tab-content text-center">
                                ...
                                <div id="show-email" style="padding-top: 30px">
                                    ...
                                    <div class="form-row" style="padding-top: 20px">
                                        <label for="checkbox_send_me_before">{{trans('billing.send_me_copy')}}:
                                            @foreach ($billings as $billing)
                                ...
                                <div class="text-align: right;">
                                    <button type="submit" id="before_submit"  class="mt-2 btn btn-success">{{trans('billing.save')}}</button>
                                </div>
                            </form>
                        </div>
                        <div class="tab-pane" id="after" role="tabpanel">
                            <form class="form-horizontal" method="POST" action="{{ route('billing-alerts.after') }}" >
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-md-6">
                                        Automatically send this alert via
                                ...
                                <div id="show-email1" style="padding-top: 30px">
                                    ...
                                    <div class="form-row">
                                        <label for="email_message_after" style="padding-top: 20px">{{trans('billing.message')}}</label>
                                        <div class="input-group">
                                            @foreach ($billings as $billing)
                                    ...
                                    <div class="form-row" style="padding-top: 20px">
                                        <label for="checkbox_send_me_after">{{trans('billing.send_me_copy')}}:
                                            @foreach ($billings as $billing)
                                ...
                                <div id="show-message1" style="display: none">
                                    <div class="form-row" >
                                        <label for="sms_message_after" style="padding-top: 20px">{{trans('billing.message')}}</label>
                                        <div class="input-group">
                                            @foreach ($billings as $billing)
