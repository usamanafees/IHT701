			...
			<div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="breadcrumb mb-5" style="margin-top: -12px">
                        ...
                        <li>
                            <a class="breadcrumb-item active" href="">{{trans('accounts.list_movements')}}</a>
                        </li>
                    </div>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>{{trans('accounts.list_movements')}}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="main-card mb-3 card">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ route('balance-movements.list') }}">
                                    {{ csrf_field() }}
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4">
                            ...
                            <table style="width: 100%;" id="example-ter" class="table table-hover table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        @endif
                                        <th>{{trans('accounts.client')}}</th>
                                        <th>{{trans('accounts.private_description')}}</th>
                                        <th>{{trans('accounts.description')}}</th>
                                        <th>{{trans('accounts.date')}}</th>
                                        <th>{{trans('accounts.hours')}}</th>
                                        <th>{{trans('accounts.movement_value')}}</th>
...
$(document).ready(function(){
    ...
    var datatables_list = $('#example-ter').DataTable( 
    {
		...
		"serverSide": true,
		"ajax":{
				 "url": "{{ route( 'balance-movements.listbalanceMovementsAjax') }}",
				 "dataType": "json",
				 "type": "POST",
...
function loadData(sms_id){
    ...
    request.onreadystatechange = function() {
        if(this.readyState === 4 && this.status === 200) {
            ...
            $("#sms_message").text(jsonResponse.data[0].message);
