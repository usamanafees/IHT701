...
@section('content')
			<div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="app-page-title">
                        ...
                        <br>
                         ...
                         <i class="fas fa-info-circle"></i>
                            <h7> {{trans('tips.movements_list')}}</h7>
                        </div>
                    </div>   
                    ...
                    <div class="main-card mb-3 card">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ route('balance-movements.list.simpleUser') }}">
                                    {{ csrf_field() }}
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4">
...
$(document).ready(function(){
    ...
    var datatables_list = $('#example-ter').DataTable( 
    {
		...
		"serverSide": true,
		"ajax":{
				 "url": "{{ route( 'balance-movements.listbalanceMovementsAjax.simpleuser') }}",
				 "dataType": "json",
				 "type": "POST",
