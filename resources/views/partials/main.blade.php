...
<head>
    ...
    <link href="{{ asset('assets/notify/css/jquery.growl.css')}}" rel="stylesheet" />
    <link href="{{ asset('assets/notify/css/notifIt.css')}}" rel="stylesheet" />
    <script src="{{ asset('assets/notify/js/notifIt.js')}}"></script>
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left"><img width="42" class="rounded" src="{{asset('admin/assets/images/avatars/1.jpg')}}" alt="" /></div>
                                        </div>
                                        <div class="widget-content-left">
                                        ...
                                        <h4 class="timeline-title">Something not important
                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/1.jpg')}}" alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/2.jpg')}}" alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/3.jpg')}}" alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/4.jpg')}}" alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/5.jpg')}}" alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/6.jpg')}}" alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/7.jpg')}}" alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                    <div class="avatar-icon"><img src="{{asset('admin/assets/images/avatars/8.jpg')}}" alt=""></div>
                                                </div>
...
<div class="modal fade template_preview_invoice" id=template_preview_invoice tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Preview Invoice</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body preview_template_modal_invoice">
                <div style="font-weight: 700;" id="template_preview_name_invoice"></div>
                <hr>
                <div>
                    <div id="header_invoice"></div>
                    <div id="body_invoice"></div>
                    <div id="footer_invoice"></div>
                </div>
