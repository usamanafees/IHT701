			...
			<div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    <div class="breadcrumb mb-5" style="margin-top: -12px">
                        ...
                        <li>
                            <a class="breadcrumb-item active" href="">{{trans('sms.sms_list')}}</a>
					...
					<div class="row mt-4">
						<div class="col-sm"  style="margin-left:35px; margin-right: 35px;">
							...
							<div class="main-box infographic-box colored red-bg">
								...
								<span class="headline" style="float:right;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{trans('sms.sms_sent')}}</font></font><br><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{trans('sms.yesterday_today')}}</font></font></span></br>
						...
						<div class="col-sm" style="margin-left:35px; margin-right: 35px;"">
								<div class="main-box infographic-box colored red-bg">
									...
									<span class="headline" style="float:right;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{trans('sms.cost_rate')}}</font></font></span>
									<br>
						...
						<div class="col-sm span3" style="margin-left:35px; margin-right: 35px;"">
							<div class="main-box infographic-box colored red-bg">
								<i class="fa fa-credit-card" style="font-size:65px;"></i>
								<span class="headline" style="float:right;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{trans('sms.balance')}}</font></font><br>&nbsp;</span></br>
                    ...
                    <div class="main-card mb-3 card">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ route('sms.list') }}">
                                    {{ csrf_field() }}
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4">
...
$(document).ready(function(){
    ...
    var datatables_list = $('#example-ter').DataTable( 
    {
		"order": [],
		...
		"serverSide": true,
		"ajax":{
				 "url": "{{ route( 'sms.listajax') }}",
				 "dataType": "json",
				 "type": "POST",
				 "data":{ _token: "{{csrf_token()}}",route:'listajax' , filter : $("#filter :selected").val(),		start_date : $("input[name='start_date']").val(), end_date : $("input[name='end_date']").val()}
			   },
		"columns": [
    {{--{ "data": 'id' },--}}
			@if ( in_array("Administrator" , Auth::user()->roles()->pluck('name')->toArray()))
            ...
            // {
            //     data = row['state'] +' &nbsp; <i style="color:red;" class="fas fa-times"></i>';
            // }
            // if(row['delivery'] === 'paid')
            // {
            //     data = row['state'] +' &nbsp; <i style="color:green;"  class="fas fa-check-double"></i>';
            // }
            }
            return data;
            }
...
function loadData(sms_id){
    ...
    request.onreadystatechange = function() {
        ...
        //    if(jsonResponse.data[0].paid_check === "error")
        //    {
        //     $("#sms_state").html(jsonResponse.data[0].state +' &nbsp; <i style="color:red;" class="fas fa-times"></i>');
        //    }
        //    if(jsonResponse.data[0].paid_check === "paid")
        //    {
        //     $("#sms_state").html(jsonResponse.data[0].state +' &nbsp; <i style="color:green;"  class="fas fa-check-double"></i>');
        //    }
        }
    };
    request.send();
