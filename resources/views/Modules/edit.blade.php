                                        ...
                                        <div class="form-row">
                                            <div class="col-md-8">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <input name="name" id="name" placeholder="Name" type="text" class="form-control" required value="{{$module->name}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group" style="top: 25%;">
                                                        <button type="submit" class="mt-2 btn btn-success">{{trans('modules.Update_brand')}}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
