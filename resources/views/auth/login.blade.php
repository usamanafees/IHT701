                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            @if(isset($emc))
                                <h4
                                @if($emc==1)
                                    <span style="margin-bottom:12px; color:green;">  Your email has been varified please log in</span>
                                @elseif($emc==3) 
                                    <span style="margin-bottom:12px; color:red;">  you have been succcessfully added to Hr module Login with the password provided in your email</span>
                                @else
                                    <span style="margin-bottom:12px; color:red;">  Your email confirmation link is broken</span>
                                @endif    
                                    </h4>
                            @endif
                            <h4 class="mb-0">
